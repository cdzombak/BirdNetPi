          ...
          <tr>
            ...
            <div class="centered_image_container" style="margin-bottom: 0px !important;">
              ...
              <form action="" method="GET">
                  ...
                  <img src="<?php echo $filename.".png";?>" style="width: 897px; height: 562px; margin-top:10px; z-index: 5;" />
                  <video style="width: 897px; height: 562px; margin-top: -562px; z-index: 10; padding: 0;" onplay='setLiveStreamVolume(0)' onended='setLiveStreamVolume(1)' onpause='setLiveStreamVolume(1)' controls preload="none" title="<?php echo $filename;?>"><source src="<?php echo $filename;?>"></video></td>
              </form>
          </tr>
        </table> <?php break;
      }
